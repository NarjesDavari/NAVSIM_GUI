...
function [Simulation,dX,P] = eskf_update1_adaptive(Simulation,dX, P_minus,dz,H,R_conventional,I,N,C,Selection_Param,flag_accelrollpitch)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%         S_conventional = R_conventional + H*P_minus*H';
%         K_conventional = P_minus*H'/S_conventional ; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% %       P = P_minus - K_white*S_white*K_white';              %Updated state covariance
   ...
   [Simulation]=R_adaptive(Simulation,R_white,N,update_counter,I,Selection_Param,flag_accelrollpitch);
