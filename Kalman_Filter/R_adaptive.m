function [Simulation]=R_adaptive(Simulation,R,N,update_Counter,I,Selection_Param,flag_accelrollpitch)
...
time_rollpitch = Selection_Param{5};
time_Heading  = Selection_Param{6};
include_GPS = Selection_Param{7};
include_depthmeter = Selection_Param{8};
include_dvl = Selection_Param{9};
include_heading = Selection_Param{10};
include_rollpitch = Selection_Param{11};
include_accelrollpitch = Selection_Param{12};


if include_GPS && ~flag_accelrollpitch
...
if include_dvl && ~flag_accelrollpitch
%     if  ~strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && ~strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
        if ~GPS_fusion_active && ~depth_fusion_active && R_DVL_active && ~Hdng_fusion_active
...
if include_depthmeter && ~flag_accelrollpitch
%     if  ~strcmp(time_IMU,time_GPS)  && ~strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
        if ~GPS_fusion_active && depth_fusion_active && ~R_DVL_active && ~Hdng_fusion_active
...
if include_rollpitch && ~flag_accelrollpitch
    if  ~strcmp(time_IMU,time_GPS)  && ~strcmp(time_IMU,time_DVL) && ~strcmp(time_IMU,time_Depth) && strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
...
if include_heading && ~flag_accelrollpitch
%      if  ~strcmp(time_IMU,time_GPS)  && ~strcmp(time_IMU,time_DVL) && ~strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
         if ~GPS_fusion_active && ~depth_fusion_active && ~R_DVL_active && Hdng_fusion_active
...
%%%%%%%%%%%%%%%%%%%%
if ~flag_accelrollpitch && include_depthmeter && include_rollpitch
    if  ~strcmp(time_IMU,time_GPS)  && ~strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
...
if ~flag_accelrollpitch && include_depthmeter && include_heading
%     if  ~strcmp(time_IMU,time_GPS)  && ~strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
       if ~GPS_fusion_active && depth_fusion_active && ~R_DVL_active && Hdng_fusion_active
            Simulation.Input.Measurements.Depth_Counter_R=Simulation.Input.Measurements.Depth_Counter_R+1;
          Simulation.Output.Kalman_mtx.R_adaptive.R_Depth(Simulation.Input.Measurements.Depth_Counter_R,1)=R(1,1);
...
if ~flag_accelrollpitch && include_rollpitch && include_heading
    if  ~strcmp(time_IMU,time_GPS)  && ~strcmp(time_IMU,time_DVL) && ~strcmp(time_IMU,time_Depth) && strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
...
if ~flag_accelrollpitch && include_depthmeter && include_dvl
    if  ~strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
...
if ~flag_accelrollpitch && include_dvl && include_rollpitch
    if  ~strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && ~strcmp(time_IMU,time_Depth) && strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
...
if ~flag_accelrollpitch && include_dvl && include_heading
%     if  ~strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && ~strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
       if ~GPS_fusion_active && ~depth_fusion_active && R_DVL_active && Hdng_fusion_active
           Simulation.Input.Measurements.DVL_Counter_R=Simulation.Input.Measurements.DVL_Counter_R+1;
        Simulation.Output.Kalman_mtx.R_adaptive.R_DVL(Simulation.Input.Measurements.DVL_Counter_R,1)=R(1,1);
...
if ~flag_accelrollpitch && include_GPS && include_depthmeter
%     if  strcmp(time_IMU,time_GPS)  && ~strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
       if GPS_fusion_active && depth_fusion_active && ~R_DVL_active && ~Hdng_fusion_active
           Simulation.Input.Measurements.GPS_Counter_R=Simulation.Input.Measurements.GPS_Counter_R+1;
          Simulation.Output.Kalman_mtx.R_adaptive.R_GPS(Simulation.Input.Measurements.GPS_Counter_R,1)=R(1,1);
...
if ~flag_accelrollpitch && include_GPS && include_dvl 
%     if  strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && ~strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
      if GPS_fusion_active && ~depth_fusion_active && R_DVL_active && ~Hdng_fusion_active
          Simulation.Input.Measurements.GPS_Counter_R=Simulation.Input.Measurements.GPS_Counter_R+1;
      Simulation.Output.Kalman_mtx.R_adaptive.R_GPS(Simulation.Input.Measurements.GPS_Counter_R,1)=R(1,1);
...
if ~flag_accelrollpitch && include_GPS &&  include_rollpitch
    if  strcmp(time_IMU,time_GPS)  && ~strcmp(time_IMU,time_DVL) && ~strcmp(time_IMU,time_Depth) && strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
        Simulation.Input.Measurements.GPS_Counter_R=Simulation.Input.Measurements.GPS_Counter_R+1;
           Simulation.Output.Kalman_mtx.R_adaptive.R_GPS(Simulation.Input.Measurements.GPS_Counter_R,1)=R(1,1);
           Simulation.Output.Kalman_mtx.R_adaptive.R_GPS(Simulation.Input.Measurements.GPS_Counter_R,2)=R(2,2);
...
if ~flag_accelrollpitch && include_GPS && include_heading
%     if  strcmp(time_IMU,time_GPS)  && ~strcmp(time_IMU,time_DVL) && ~strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
        if GPS_fusion_active && ~depth_fusion_active && ~R_DVL_active && Hdng_fusion_active
            Simulation.Input.Measurements.GPS_Counter_R=Simulation.Input.Measurements.GPS_Counter_R+1;
            Simulation.Output.Kalman_mtx.R_adaptive.R_GPS(Simulation.Input.Measurements.GPS_Counter_R,1)=R(1,1);
...
if flag_accelrollpitch && include_GPS
%     if  strcmp(time_IMU,time_GPS)  && ~strcmp(time_IMU,time_DVL) && ~strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
        if GPS_fusion_active && ~depth_fusion_active && ~R_DVL_active && ~Hdng_fusion_active
            Simulation.Input.Measurements.GPS_Counter_R=Simulation.Input.Measurements.GPS_Counter_R+1;
        Simulation.Output.Kalman_mtx.R_adaptive.R_GPS(Simulation.Input.Measurements.GPS_Counter_R,1)=R(1,1);
...
if flag_accelrollpitch && include_dvl 
%     if  ~strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && ~strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
        if ~GPS_fusion_active && ~depth_fusion_active && R_DVL_active && ~Hdng_fusion_active
            Simulation.Input.Measurements.DVL_Counter_R=Simulation.Input.Measurements.DVL_Counter_R+1;
        Simulation.Output.Kalman_mtx.R_adaptive.R_DVL(Simulation.Input.Measurements.DVL_Counter_R,1)=R(1,1);
...
if flag_accelrollpitch && include_depthmeter
%     if  ~strcmp(time_IMU,time_GPS)  && ~strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
        if ~GPS_fusion_active && depth_fusion_active && ~R_DVL_active && ~Hdng_fusion_active
             Simulation.Input.Measurements.Depth_Counter_R=Simulation.Input.Measurements.Depth_Counter_R+1;
           Simulation.Output.Kalman_mtx.R_adaptive.R_Depth(Simulation.Input.Measurements.Depth_Counter_R,1)=R(1,1); 
...
if flag_accelrollpitch && include_heading
%     if  ~strcmp(time_IMU,time_GPS)  && ~strcmp(time_IMU,time_DVL) && ~strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
       if ~GPS_fusion_active && ~depth_fusion_active && ~R_DVL_active && Hdng_fusion_active
           Simulation.Input.Measurements.accelrollpitch_Counter_R= Simulation.Input.Measurements.accelrollpitch_Counter_R+1;
        Simulation.Output.Kalman_mtx.R_adaptive.R_accelrollpitch(Simulation.Input.Measurements.accelrollpitch_Counter_R,1)=R(1,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if ~flag_accelrollpitch &&  include_depthmeter && include_rollpitch && include_heading
    if  ~strcmp(time_IMU,time_GPS)  && ~strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
...
if ~flag_accelrollpitch &&  include_depthmeter && include_dvl && include_rollpitch
    if  ~strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
...
if ~flag_accelrollpitch &&  include_depthmeter && include_dvl && include_heading
%     if  ~strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
       if ~GPS_fusion_active && depth_fusion_active && R_DVL_active && Hdng_fusion_active
            Simulation.Input.Measurements.Depth_Counter_R=Simulation.Input.Measurements.Depth_Counter_R+1;
          Simulation.Output.Kalman_mtx.R_adaptive.R_Depth(Simulation.Input.Measurements.Depth_Counter_R,1)=R(1,1);
...
if ~flag_accelrollpitch && include_dvl && include_rollpitch && include_heading
    if  ~strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && ~strcmp(time_IMU,time_Depth) && strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
...
if ~flag_accelrollpitch &&  include_GPS && include_depthmeter && include_dvl
%    if  strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
       if GPS_fusion_active && depth_fusion_active && R_DVL_active && ~Hdng_fusion_active
           Simulation.Input.Measurements.GPS_Counter_R=Simulation.Input.Measurements.GPS_Counter_R+1;
           Simulation.Output.Kalman_mtx.R_adaptive.R_GPS(Simulation.Input.Measurements.GPS_Counter_R,1)=R(1,1);
...
if ~flag_accelrollpitch &&  include_GPS && include_depthmeter && include_rollpitch
   if  strcmp(time_IMU,time_GPS)  && ~strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
...
if ~flag_accelrollpitch &&  include_GPS && include_depthmeter && include_heading
%    if  strcmp(time_IMU,time_GPS)  && ~strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
       if GPS_fusion_active && depth_fusion_active && ~R_DVL_active && Hdng_fusion_active
           Simulation.Input.Measurements.GPS_Counter_R=Simulation.Input.Measurements.GPS_Counter_R+1;
           Simulation.Output.Kalman_mtx.R_adaptive.R_GPS(Simulation.Input.Measurements.GPS_Counter_R,1)=R(1,1);
...
if ~flag_accelrollpitch &&  include_GPS  && include_dvl && include_rollpitch
   if  strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && ~strcmp(time_IMU,time_Depth) && strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
...
if ~flag_accelrollpitch &&  include_GPS  && include_dvl && include_heading
%    if  strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && ~strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
       if GPS_fusion_active && ~depth_fusion_active && R_DVL_active && Hdng_fusion_active
           Simulation.Input.Measurements.GPS_Counter_R=Simulation.Input.Measurements.GPS_Counter_R+1;
           Simulation.Output.Kalman_mtx.R_adaptive.R_GPS(Simulation.Input.Measurements.GPS_Counter_R,1)=R(1,1);
...
if ~flag_accelrollpitch &&  include_GPS  && include_rollpitch && include_heading 
   if  strcmp(time_IMU,time_GPS)  && ~strcmp(time_IMU,time_DVL) && ~strcmp(time_IMU,time_Depth) && strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
...
if flag_accelrollpitch && include_dvl && include_depthmeter
%     if ~strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
        if ~GPS_fusion_active && depth_fusion_active && R_DVL_active && ~Hdng_fusion_active
             Simulation.Input.Measurements.Depth_Counter_R=Simulation.Input.Measurements.Depth_Counter_R+1;
            Simulation.Output.Kalman_mtx.R_adaptive.R_Depth(Simulation.Input.Measurements.Depth_Counter_R,1)=R(1,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if ~flag_accelrollpitch && include_dvl && include_depthmeter && include_rollpitch && include_heading
   if  ~strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
...
if ~flag_accelrollpitch && include_GPS && include_dvl && include_depthmeter && include_rollpitch
   if  strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && strcmp(time_IMU,time_rollpitch) && ~strcmp(time_IMU,time_Heading)
...
if ~flag_accelrollpitch && include_GPS && include_dvl && include_depthmeter && include_heading
%     if  strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
        if GPS_fusion_active && depth_fusion_active && R_DVL_active && Hdng_fusion_active
            Simulation.Input.Measurements.GPS_Counter_R=Simulation.Input.Measurements.GPS_Counter_R+1;
            Simulation.Output.Kalman_mtx.R_adaptive.R_GPS(Simulation.Input.Measurements.GPS_Counter_R,1)=R(1,1);
...
if ~flag_accelrollpitch && include_GPS && include_dvl && include_rollpitch && include_heading
   if  strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && ~strcmp(time_IMU,time_Depth) && strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
...
if ~flag_accelrollpitch && include_GPS  && include_depthmeter && include_rollpitch && include_heading
   if  strcmp(time_IMU,time_GPS)  && ~strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
...
%     end
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 if ~flag_accelrollpitch && include_GPS && include_depthmeter && include_dvl && include_rollpitch && include_heading
    if  strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
...
Simulation.Input.Measurements.GPS_Counter_R_R=Simulation.Input.Measurements.GPS_Counter_R_R+1;
 ...
 if flag_accelrollpitch && include_GPS && include_depthmeter && include_dvl &&  include_heading
%      if  strcmp(time_IMU,time_GPS)  && strcmp(time_IMU,time_DVL) && strcmp(time_IMU,time_Depth) && ~strcmp(time_IMU,time_rollpitch) && strcmp(time_IMU,time_Heading)
         if GPS_fusion_active && depth_fusion_active && R_DVL_active && Hdng_fusion_active
             Simulation.Input.Measurements.GPS_Counter_R=Simulation.Input.Measurements.GPS_Counter_R+1;
             Simulation.Output.Kalman_mtx.R_adaptive.R_GPS(Simulation.Input.Measurements.GPS_Counter_R,1)=R(1,1);
