function [ Simulation , gl, ave_fb , ave_W ] = Coarse_Alignment( Simulation,gg , ave_sample,Misalignment_IMU_phins  )    
...
%             Z(I,1)   = 0;
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    x=[Simulation.Output.INS.X_INS(1,1), Simulation.Output.INS.X_INS(1,2),Simulation.Output.INS.X_INS(1,3)];
    [gl,Simulation] = Gravity(  Simulation, x , gg,I  );
    ...
    if ~isempty(nonzeros(CA.Yaw))
        Simulation.Output.INS.X_INS(1,9) = mean (nonzeros(CA.Yaw)) + Misalignment_IMU_phins(3)*pi/180;
    else
