...
function [Simulation,flag_Qadapt]=AQ_calcul(x,C,Simulation,fs,I,gg,tau,dt,Include_Q_adaptive,flag_Qadapt,ave_sample)
...
%         q_b_gz=2*Simulation.Output.Kalman_mtx.Qc.q_Bwz/tau(6);
        ...
        [F,G,Simulation]=FG_calcul(Simulation,I,x,C,gg,tau,sigma_bias,dt,ave_sample);
