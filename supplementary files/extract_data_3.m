...
function [Simulation]=extract_data_3(Simulation , handles_listbox_log)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    User_Roll = Simulation.Input.User_Def_Sim.Path.User_Roll;
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %Sampling frequency
	fs         = GetParam(Simulation.Init_Value ,'Sampling_Frequency');
    Station_Step = 60 * fs + 1;
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%         phi2=Simulation.Input.User_Def_Sim.Path.User_Roll((Dlength-1)/2+1:end-1,1);%%%???????
        phi2=Simulation.Input.User_Def_Sim.Path.User_Roll(a:end-1,1);
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
